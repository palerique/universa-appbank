 ...
 */
public final class FachadaBancaria {
	...
	public int abreConta(Cliente titular, TipoDaConta tipoDaConta) throws Exception {
	...
	public void transfereEntreContas(Conta contaDeOrigem, Conta contaDeDestino, double valor) throws Exception {

		ControladorConta.get().transfereEntreContas(contaDeOrigem, contaDeDestino, valor);
	}
}